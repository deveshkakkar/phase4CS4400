  ...
  return (
    ...
    <input
      ...
      onClick={() => {
        ...
        Axios.post('http://localhost:3002/api/start_customer_role',  {perID: perID, SSN: SSN, fname: fname, lname: lname, bday:bday, street: street, city: city, state: state, zip: zip, dtjoin: dtjoin, password: password})
    }}
    />
    <input
      class="m-1"
